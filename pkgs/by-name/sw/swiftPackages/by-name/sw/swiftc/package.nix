...
#    "lib"
  ...
  postUnpack = lib.optionalString (bootstrapStage >= 1) ''
    ln -s ${lib.escapeShellArg (lib.getDev swift-experimental-string-processing)}/source "$NIX_BUILD_TOP/swift-experimental-string-processing"
    ln -s ${lib.escapeShellArg (lib.getDev swift-syntax)}/source "$NIX_BUILD_TOP/swift-syntax"
  '';
...
#    ./patches/0005-separate-lib.patch

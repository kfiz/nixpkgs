...
in
{
  ...
  options.services.dovecot2 = {
    ...
    package = mkPackageOption pkgs "dovecot" { } // {
      ...
      defaultText = lib.literalExpression ''if versionAtLeast config.system.stateVersion "26.05" then pkgs.dovecot_2_4 else pkgs.dovecot_2_3'';
    };
          ...
          toplevel = submodule {
            options = {
              ...
              default_internal_user = mkOption {
                default = cfg.user;
                defaultText = literalExpression "config.services.dovecot2.user";
                description = ''
              ...
              default_internal_group = mkOption {
                default = cfg.group;
                defaultText = literalExpression "config.services.dovecot2.group";
                description = ''
  ...
  config = mkIf cfg.enable {
    ...
    assertions = [
      {
        assertion = !isPre24 -> cfg.settings.dovecot_config_version or null != null;
        message = ''
      ...
      {
        assertion = !isPre24 -> cfg.settings.dovecot_storage_version or null != null;
        message = ''
